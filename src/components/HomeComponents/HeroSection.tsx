      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 h-full flex flex-col justify-center">
        ...
        <div className="mt-5 flex flex-col sm:flex-row gap-4">
          ...
          <div className="relative">
            ...
            {isGetOpen && (
              <div className="absolute bottom-full mb-2 left-0 w-72 max-w-[calc(100vw-2rem)] bg-white rounded-xl shadow-2xl z-50 xl:bottom-auto xl:mb-0 xl:top-full xl:mt-2">
                <div className="p-2">
