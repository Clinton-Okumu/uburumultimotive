    ...
    <section className="relative py-24 px-4 bg-gradient-to-b from-white via-white to-gray-50 overflow-hidden">
      ...
      <div className="container mx-auto max-w-7xl relative">
        ...
        <div className="mt-16 text-center">
          <a
            href="https://www.instagram.com/uburumultimove_ngo?igsh=MXgzeWR5N2YyZTkz"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 bg-gradient-to-r from-purple-600 via-pink-500 to-orange-400 hover:from-purple-500 hover:via-pink-400 hover:to-orange-300 text-white font-bold uppercase tracking-wide py-4 px-8 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
          >
          ...
          <p className="text-gray-500 mt-4 text-sm">
            Follow us @uburumultimove_ngo for daily updates
          </p>
        </div>
