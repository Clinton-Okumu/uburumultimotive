...
function calculate_village_checkout_totals(array $items): array
{
    $rateMap = [
        ...
        'kids-outdoor-adventure-resident' => ['name' => 'Kids Outdoor & Wellness Adventure (Resident)', 'currency' => 'KES', 'price' => 3500],
        'therapeutic-trip-resident' => ['name' => 'Therapeutic trip (Kitengela) (Resident)', 'currency' => 'KES', 'price' => 4500],
