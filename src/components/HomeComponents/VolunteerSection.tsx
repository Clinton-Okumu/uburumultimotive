...
const GallerySection = () => {
    const galleryImages = [
        ...
        { id: 6, src: "https://images.unsplash.com/photo-1509099836639-18ba1795216d?w=900&q=80", alt: "Compassion in action" }
    ];
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6 tracking-tight">
                        Relief in <span className="text-yellow-500 font-black italic">Action</span>
                    </h2>
