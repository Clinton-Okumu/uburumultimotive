...
export const homeCategories: HomeCategory[] = [
  {
    ...
    description: "Curated everyday essentials, inspirational books, and signature apparel. Every purchase funds shelter and care.",
    type: "product",
  ...
  },
  {
    ...
    tagline: "Style that supports a cause. Quality tees, hoodies, and headwear.",
    description: "Comfortable premium apparel made from breathable heavy-weight cotton that funds community impact.",
    type: "product",
    iconName: "Shirt",
