...
const MedicalConsultationFormSection = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatus("sent");
      toast.success("Medical consultation request submitted successfully!");
    } catch (error) {
      setStatus("error");
    ...
    return (
      <div className="bg-white rounded-[2.5rem] p-10 md:p-14 shadow-xl border border-neutral-100 text-center max-w-2xl mx-auto">
        ...
        <p className="text-gray-600 leading-relaxed mb-8">
          Thank you for reaching out to Uburu Medical Services. Our healthcare team will review your consultation request and contact you to schedule your session.
        </p>
        <button
          type="button"
          onClick={onBack}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-[2rem] p-7 md:p-8 border border-neutral-200/80 shadow-sm space-y-5">
            ...
            <textarea
              ...
              onChange={handleTextChange}
              rows={3}
              placeholder="Please describe any past surgeries or write 'None'"
              className="w-full px-5 py-4 bg-neutral-50/80 border border-neutral-200/80 rounded-2xl focus:outline-none focus:ring-2 focus:ring-yellow-400 font-bold transition-all text-gray-900 placeholder:text-gray-400 resize-none"
            />
          </div>
          ...
          <div className="bg-white rounded-[2rem] p-7 md:p-8 border border-neutral-200/80 shadow-sm space-y-5">
            <h3 className="text-xl font-bold text-gray-900">
              Family medical history of serious conditions? <span className="text-red-500">*</span>
            </h3>
            <textarea
              ...
              onChange={handleTextChange}
              rows={3}
              placeholder="Please describe any significant family medical history or write 'None'"
              className="w-full px-5 py-4 bg-neutral-50/80 border border-neutral-200/80 rounded-2xl focus:outline-none focus:ring-2 focus:ring-yellow-400 font-bold transition-all text-gray-900 placeholder:text-gray-400 resize-none"
            />
          </div>
