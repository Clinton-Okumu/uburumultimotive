  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-white container mx-auto px-6 max-w-4xl">
        ...
        <div className="inline-flex items-center gap-3 rounded-full border border-yellow-400/60 bg-black/70 px-4 py-2 shadow-[0_10px_30px_rgba(0,0,0,0.35)] mb-4">
        ...
        <h1 className="text-5xl font-bold mb-3 text-yellow-400 drop-shadow-[0_2px_6px_rgba(0,0,0,0.7)]">
          Uburu Home
        </h1>
